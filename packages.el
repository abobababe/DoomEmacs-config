...
(package! mchp-chat
  :recipe (:local-repo "/home/c64357/dev/emacs-microchip-chatbot/"
...
(package! jenkinsfile-mode :recipe
  (:host github
   :repo "abobababe/jenkinsfile-mode"
   :branch "master"))
...
(package! jinja-mode :recipe
  (:host github
   :repo "cat-emacs/jinja2-ts-mode"
   :branch "main"))

(package! nov
  :recipe (:local-repo "/home/c64357/dev/nov.el/"
           ;; By default, the package manager grabs all *.el files at the root
           ;; of the project and nothing else. To include other files, or
           ;; accommodate unconventional project structures, specify what :files
           ;; you want:
